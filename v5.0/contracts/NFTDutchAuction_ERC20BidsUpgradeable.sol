...
* Create a new contract called NFTDutchAuction_ERC20BidsUpgradeable.sol. It should have the same functionality as NFTDutchAuction.sol but accepts only ERC20 bids instead of Ether.
* The constructor for the NFTDutchAuction_ERC20BidsUpgradeable.sol should be:
